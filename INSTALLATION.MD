...
# Easy deploy using rchain-token
# prints deploy ID
dappy-easy-deploy-rnode helloworld.rho
# Waits for something on deploy ID unforgeable name
dappy-easy-deploy-rnode helloworld.rho --wait
