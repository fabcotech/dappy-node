...
`DAPPY_NETWORK` is read by Dappy browser, to know what is the name of the Dappy network, currently it needs the network to be called betanetwork, could it be on mainnet or testnet.
